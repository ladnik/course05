...
func transition_effect(scene: String) -> void:
	...
	if current_scene and current_scene.has_method("get_scene_file"):
		...
		if current_scene.get_scene_file() != "res://scenes/win_screen.tscn" and current_scene.get_scene_file() != "res://scenes/lose_screen.tscn":
	...
	if scene != "res://scenes/win_screen.tscn" and scene != "res://scenes/lose_screen.tscn":
		prevscene = scene
